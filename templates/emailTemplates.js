...
// --- HELPER FUNCTION: Generate Google Calendar Link ---
  ...
  const htmlContent = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <div style="background-color: #d1ecf1; padding: 15px; border-radius: 5px; margin: 20px 0; border-left: 4px solid #bee5eb;">
        <h4 style="color: #2c3e50; margin-top: 0;">Next Steps:</h4>
        <ul>
          <li><strong>Click the button below to add to your calendar</strong></li>
          <li>Stay in touch with the student to arrange the meeting venue</li>
          <li>Prepare any necessary materials for the topic</li>
        </ul>
      </div>
      ...
      <div style="text-align: center; margin: 25px 0;">
        <a href="${calendarLink}" target="_blank" style="background-color: #2c3e50; color: #ffffff; padding: 12px 24px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;">📅 Add to Google Calendar</a>
      </div>
